        ...
        <div className="home">
            ...
            <section>
                ...
                <header className="header-banner">
                    <img  src="./assets/images/hotel.webp" alt="stayFinder" className="header-image" />
                    <div className="overlay"></div>
                    <div className="animated-texts overlay-content">
                        <h1>
                            Welcome to <span className="phegon-color">stayFinder</span>
                        </h1><br />
            ...
            <h2 className="home-services">Services at <span className="phegon-color">stayFinder</span></h2>
            ...
            <section className="service-section"><div className="service-card">
                ...
                <div className="service-card">
                    ...
                    <div className="service-details">
                        ...
                        <p className="service-description">Enjoy a convenient selection of beverages and snacks stocked in your room's mini shop with no additional cost.</p>
                    </div>
                </div>
                <div className="service-card">
